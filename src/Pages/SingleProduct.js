...
const SingleProduct = (props) => {
    ...
    const images = {
        ...
        height: 600, 
        zoomWidth: 600, 
        img: "https://www.homelane.com/blog/wp-content/uploads/2022/10/bedroom-glass-wall-designs.jpg"};
            ...
            <div className='col-6'>
                <div className='main-product-details'>
                    <div className='border-bottom '>
                        <h3>Colored glass 20 Sets rainbow color for Any place - {id}</h3>
                    </div>
                    ...
                    <div className='border-bottom py-3'>
                        <div className='d-flex gap-10 align-items-center my-2'>
                            ...
                            <p className='product-data' >Glass</p>
                        </div>
                        <div className='d-flex gap-10 align-items-center my-2'>
                            <h4 className='product-heading' >Category :</h4> 
                            <p className='product-data' >Colored glass</p>
                        </div>
                        <div className='d-flex gap-10 align-items-center my-2'>
                        ...
                        <div className='d-flex gap-10 align-items-center my-2'>
                            ...
                            <p className='product-data' >Within <b>03 -07 business days</b> deliver the product after payment. 
            ...
            <div className='row'>
                ...
                <div className='bg-white p-3'>
                        <p>
                            ...
                            indicates a one-to-one relationship, denoted by "1" on both sides of the relationship line. 
                            The relationship between Order, Customer, Employee, and GlassItem indicates a 
                            one-to-many relationship, denoted by "1" on the side of the "Order" entity and "*" on the other side.
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div className='reviews mt-4'>
                            <div className='review'>
                               <div className='d-flex gap-10 align-items-center'>
                                ...
                                <p className='mt-3'> Please note that the fk annotation on the connecting lines indicates foreign keys, 
                            linking the entities to their corresponding primary keys in other entities. 
                            The relationship between Customer and User, as well as between Employee and User, 
